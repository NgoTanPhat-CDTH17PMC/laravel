...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				<h4 class="header-title">Danh Sách Gói Credit Đã Xoá</h4><br>
								        ...
								        <div class="modal-dialog modal-dialog-centered" role="document">
								            <div class="modal-content">
								                ...
								                <div class="modal-header">
								                    <h5 class="modal-title">Khôi Phục Gói Credit</h5>
								                ...
								                <div class="modal-body">
								                    <div class="row">
								                        <h4 style="padding-left: 75px;">Bạn có muốn khôi phục gói credit này không?</h4>
								                    </div>
								                    <div class="row">
								                        <label style="padding-left: 75px; display: block">{{ $table->ten_goi }}</label>
								                    </div>
								                </div>

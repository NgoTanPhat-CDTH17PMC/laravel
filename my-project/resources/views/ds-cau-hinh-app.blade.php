				                ...
				                <div class="modal-body">
				                    <div class="row">
				                        <div class="form-group col-md-8">
                    						...
                    						<input type="number" min="0" max="4" maxlength="1" class="form-control" name="co_hoi_sai" id="co_hoi_sai" placeholder="Nhập vào cơ hội sai">
								            ...
								            <div class="modal-content">
								                ...
								                <div class="modal-body">
								                    <div class="row">
								                        <div class="form-group col-md-8">
								                            <label for="co_hoi_sai">Cơ hội sai</label>
								                            <input type="number" min="0" max="4" maxlength="1" class="form-control" name="co_hoi_sai" id="co_hoi_sai" value="{{ $table->co_hoi_sai }}"></br>
								                        </div>
								                    </div>
								                    <div class="row">
								                        <div class="form-group col-md-8">
